...
export default function Modal({show, onClose, children}){
    ...
    const modalContent = show ? (
        <Overlay>
            <div tw="flex items-center justify-center py-10 h-full relative">
                <div tw="z-50 overflow-auto cursor-auto w-auto max-w-3xl">
                    <div tw='grid grid-cols-12 px-6 py-4 shadow-md rounded mx-auto bg-white '>
